...
if __name__ == "__main__":
    ...
    csv_file = "/external/rprshnas01/tigrlab/scratch/bng/cartbind/data/ukb_master_TMT_no_outliers.csv"
    fc_regions_file = "/external/rprshnas01/tigrlab/scratch/bng/cartbind/code/MIND_models/region_names/FC_regions.txt"
    output_directory = "/external/rprshnas01/tigrlab/scratch/bng/cartbind/data/FC_matrices/TMT"
