...
# %% [markdown]
# ### Using CT to predict Fluid Intelligence Score
...
def hyper_parameter_optimization(data_df, input_variables, output_variable, numeric_vars, 
    ...
    for splt_idx, (train_idx, test_idx) in enumerate(split_object.split(blocks, y)):
        ...
        dir_name = f'/scratch/bng/cartbind/data/hyperparameters/best_hyperparameters_CT_reg_07-20/{output_variable}/split_{splt_idx}'
