...
<img width="8181" height="4583" alt="SOBP Poster Workflow Figure" src="https://github.com/user-attachments/assets/09c3f5e1-0c46-495f-aca4-9472a8c58b8b" />
...
2. **`models_plsregression_dnanexus`**: Python scripts and notebooks for **PLS regression** modelling and analysis
3. **`models_xgboost_dnanexus`**: Scripts and notebooks for **XGBoost** modelling and analysis
4. **`models_elasticnet_dnanexus`**: Scripts and notebooks for **Elastic Net regression** modelling and analysis
...
3. Autoencoders for functional and structural connectivity
