...
# Load column names from text files
...
# Append columns from text files
required_cols.extend(load_columns_from_file('/Users/baileyng/MIND_models/region_names/demo_cols_dnanexus.txt'))
required_cols.extend(load_columns_from_file('/Users/baileyng/MIND_models/region_names/CT_regions_dnanexus.txt'))
required_cols.extend(load_columns_from_file('/Users/baileyng/MIND_models/region_names/FC25_colnames.txt'))
required_cols.extend(load_columns_from_file('/Users/baileyng/MIND_models/region_names/FC100_colnames.txt'))

optional_cols = ['p20016_i2', 'p20197_i2', 'p23324_i2', 'p6350_i2', 'p6351_i2'] # Cognitive assessment data
